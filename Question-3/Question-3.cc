...
/// <summary>
/// Question 3: This is an extension task. Look at the interface class Observer. This class's responsibility 
...
/// file at the root of this repository, to make Question-5 utilise Google Tests. You also need to modify this file, to implement the mock, and
